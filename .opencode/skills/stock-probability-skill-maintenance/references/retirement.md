...
1. Search the catalog, project skill index, project skills, agent profiles, commands, and authored
...
Never rewrite historical evidence to erase a retired skill. Never stage files in the Git index,
commit, push, export, or use an external state service as part of retirement; the normal `EXP-*`
gate handles the reviewed repository checkpoint.
