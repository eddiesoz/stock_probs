...
- **L1:** exact original ASTRA command, sessions, environment, UTC, commit, artifact revision,
  and reviewer were not supplied.
- **L2:** the cited SOL repair was implementation evidence at first review; exact independent
  repair-QA metadata remain unavailable even where the supplied re-evaluation reports resolution.
...
- **L7:** the walkthrough was generated from the recorded dirty revision; acceptance and export
  revision binding remain pending.
...
| `A020` | `POST /api/v1/history/{event_id}/reconstructions` | Separately labelled fresh cutoff analysis | Needs improvement | `R-ASTRA-6`–`R-ASTRA-10` fresh-analysis context | L1, L2 |
...
| `C035` | Show up to 10 headlines button, `static/app.js:450-454` | Expand a full five-item news response through a bounded `limit=10` request | Meets | Browser news regression; `M09-E18` | L1, L3 |
| `C036` | Review detailed provenance link, `static/app.js:831-834` | Move from a stale-data reason to the detailed forecast provenance | Meets | Browser stale-result regression; walkthrough result frames | L1, L4 |
| `C037` | View failed request button, `static/app.js:1243-1245` | Open the immutable audit detail for a failed search | Meets | Browser history regression; `M07-E18` | L1, L6 |
...
| `S021` | Fresh historical-cutoff analysis | Label new calculation “Not the saved forecast” with source context | Needs improvement | `R-ASTRA-6`–`R-ASTRA-10`; walkthrough step 09 | L1, L2 |
...
| `H004` | Return-tail SVG chart | Show loss/gain threshold curves without color-only meaning | Needs improvement | `R-ASTRA-1`–`R-ASTRA-5` chart typography | L1, L2, L6 |
| `H005` | Chart axes, tick labels, and legend | Make scale and series visually legible at all viewports | Needs improvement | `R-ASTRA-1`–`R-ASTRA-5` chart typography | L1, L2, L4 |
...
| `N010` | Instrument changed/request superseded | Abort old request and render no stale-symbol headlines | Needs improvement | `R-ASTRA-6`–`R-ASTRA-10`; companion frame | L1, L2, L3 |
...
| `V005` | Desktop 05 chart and table PNG | Focused threshold point visual | Acceptable | `docs/walkthrough/images/desktop-05-chart-and-table.png` | L1, L2, L7 |
...
| `V009` | Desktop 09 fresh reconstruction PNG | Distinct fresh analysis visual | Acceptable | `docs/walkthrough/images/desktop-09-fresh-reconstruction.png` | L1, L2, L7 |
...
| `V026` | Desktop superseded-news PNG | Aborted stale request visual | Acceptable | `docs/walkthrough/images/desktop-20-news-superseded.png` | L1, L2, L3, L7 |
...
| `V031` | Mobile 05 chart and table PNG | Mobile focused chart-point visual | Acceptable | `docs/walkthrough/images/mobile-05-chart-and-table.png` | L1, L2, L4, L7 |
...
| `V035` | Mobile 09 fresh reconstruction PNG | Mobile fresh-analysis visual | Acceptable | `docs/walkthrough/images/mobile-09-fresh-reconstruction.png` | L1, L2, L4, L7 |
...
| `V052` | Mobile superseded-news PNG | Mobile aborted stale-request visual | Acceptable | `docs/walkthrough/images/mobile-20-news-superseded.png` | L1, L2, L3, L4, L7 |

## Supporting media

| ID | Item/source | Requirement served | Verdict | Evidence reference | Limitation |
| --- | --- | --- | --- | --- | --- |
| `M001` | Walkthrough manifest JSON | Bind fixture, generation, requests, viewports, states, and media | Acceptable | `docs/walkthrough/manifest.json`; `R-ASTRA-13` | L1, L2, L7 |
...
| `W009` | Step 09: run fresh reconstruction | Distinguish a new cutoff analysis from saved evidence | Acceptable | `docs/walkthrough/index.md`, step 09 | L1, L2, L4, L7 |
...
| `W020` | Step 20: separate saved evidence/current news | Prove optional disclosure and zero request delta | Acceptable | `docs/walkthrough/index.md`, step 20 and companions | L1, L2, L3, L4, L7 |
...
- **Status:** Completed for the owned documentation and developer-test scope; a subsequent
  ASTRA acceptance verdict is not inferred.
...
- **Finding closure:** the control-inventory and per-row evidence-record gaps found by the final
  re-evaluation are resolved in these artifacts. Actual screen-reader evidence, native/physical
  ARM64 performance, and physical-mobile evidence remain explicitly unavailable.
