---
title: "Threat model"
description: "Threats and controls for loopback HTTP, untrusted requests, Yahoo data, SQLite state, exports, and managed backup artifacts."
---
...
| Provider delay or malformed Yahoo content | Explicit 1–20 second configured timeout, bounded lookup/history calls, provider concurrency of two, normalized identity/bar contracts, and no provider objects exposed by transport. |
...
machine. Do not disable verification to recover an artifact.
